module.exports = {
  ...
  execute: async (client, message, args) => {
    ...
    if (month === 1) {
      if (day >= 1 && day <= 19)
        return message.reply(" your zodiac is Capricorn");
      if (day >= 20 && day <= 31)
        return message.reply(" your zodiac is Aquarius");
      return message.reply(" please enter a valid date.");
    } else if (month === 2) {
      if (day >= 1 && day <= 18)
        return message.reply(" your zodiac is Aquarius");
      if (day >= 19 && day <= 29)
        return message.reply(" your zodiac is Pisces");
      return message.reply(" please enter a valid date.");
    } else if (month === 3) {
      ...
      if (day >= 20 && day <= 31)
        return message.reply(" your zodiac is Taurus");
      return message.reply(" please enter a valid date.");
    } else if (month === 5) {
      if (day >= 1 && day <= 20) return message.reply(" your zodiac is Taurus");
      if (day >= 21 && day <= 31)
        return message.reply(" your zodiac is Gemini");
      return message.reply(" please enter a valid date.");
    } else if (month === 6) {
      if (day >= 1 && day <= 20) return message.reply(" your zodiac is Gemini");
      if (day >= 21 && day <= 31)
        return message.reply(" your zodiac is Cancer");
      return message.reply(" please enter a valid date.");
    } else if (month === 7) {
      ...
      if (day >= 23 && day <= 31)
        return message.reply(" your zodiac is Scorpio");
      return message.reply(" please enter a valid date.");
    } else if (month === 11) {
      if (day >= 1 && day <= 21)
        return message.reply(" your zodiac is Scorpio");
      if (day >= 22 && day <= 31)
        return message.reply(" your zodiac is Sagittarius");
      return message.reply(" please enter a valid date.");
    } else if (month === 12) {
      if (day >= 1 && day <= 21)
        return message.reply(" your zodiac is Sagittarius");
